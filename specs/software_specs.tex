...
Using the camera the User can then select an origin point and place calibration grids \ref{fig:grid} within the \glsname{VR}. The user then capture the placement of the calibration grids as images.
