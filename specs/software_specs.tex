...
As descriped in\ref{fig:uco}, users can perform the camera calibration procedure as defined in chapter two of \cite{CC}. 

The steps involved are: 

\begin{enumerate}
\item Making A Camera
\item Second
\item Third
\item Last
\end{enumerate}
...
\subsubsection{Simulating Distortion } 
