...
\newacronym[\glsshortpluralkey=HTML5]{HTML5}{HTML5}{HTML5: Is the fifth version of the Hypertext Markup Language that provides many new features such as canvas and web sockets}
\newacronym[\glsshortpluralkey=WebGL]{WebGL}{WebGL}{WebGL: A web technology being developed by the Khronos Group to bring accelerated graphics to the web browser, on a canvas}
